      ...
      <Menu
        ...
        <MenuItem
          onClick={() => {
            ...
            getContextMenuCommandDistanceSigIntUHFGnd("INFO");
            handleClose();
          }}>
          Інформація про лінію дальності розвідки в УКХ діапазоні по наземних
          цілях
        </MenuItem>
        <MenuItem
          onClick={() => {
            setEditableProperty(true);
            getContextMenuCommandDistanceSigIntUHFGnd("EDIT");
            handleClose();
          }}>
          Редагувати лінію дальності розвідки в УКХ діапазоні по наземних цілях
        </MenuItem>
        <MenuItem
          onClick={() => {
            getContextMenuCommandDistanceSigIntUHFGnd("DELETE");
            handleClose();
          }}>
          Видалити лінію дальності розвідки в УКХ діапазоні по наземних цілях
        </MenuItem>
      </Menu>
    </React.Fragment>
  );
